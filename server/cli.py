...
from FastChat.fastchat.model.model_adapter import add_model_args
from server.inference import chat_loop, ChatIO
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--speech-file", type=str, default=None, help="speech file path."
    )
    parser.add_argument(
