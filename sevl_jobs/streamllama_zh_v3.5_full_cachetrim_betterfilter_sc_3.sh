...
max_speech_cache_size_list=(240 480 960 1920)
max_speech_cache_size=${max_speech_cache_size_list[$SLURM_ARRAY_TASK_ID-1]}
...
simuleval \
    ...
    --output ${ckpt_dir}/simul-results-full-betterfilterbadwords/sc${max_speech_cache_size}_run3_cache${max_llm_cache_size}_seg${src_segment_size}_beam${beam}_ms${ms}_nrnl${no_repeat_ngram_lookback}_nrns${no_repeat_ngram_size}_bsz${pseudo_batch_size} \
