...
ckpt_dir=/compute/babel-5-23/siqiouya/runs/en-zh/8B-traj-s2-v3.5_seg/last.ckpt/
...
simuleval \
    ...
    --output ${ckpt_dir}/simul-results-full-betterfilterbadwords/suppress-non-language_cache${max_llm_cache_size}_seg${src_segment_size}_beam${beam}_ms${ms}_nrnl${no_repeat_ngram_lookback}_nrns${no_repeat_ngram_size} \
