...
ckpt_dir=/compute/babel-5-23/siqiouya/runs/8B-traj-s3-v3.3/last.ckpt/
...
simuleval \
    ...
    --output ${ckpt_dir}/simul-results-full/cache${max_llm_cache_size}_seg${src_segment_size}_beam${beam}_ms${ms}_nrnl${no_repeat_ngram_lookback}_nrns${no_repeat_ngram_size} \
