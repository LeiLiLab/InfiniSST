...
ckpt_dir=/compute/babel-5-23/siqiouya/runs/en-zh/8B-traj-s2-v3.5_llama3/last.ckpt/
...
simuleval \
    ...
    \
    --model-name /compute/babel-4-1/siqiouya/llama-3-8b-instruct-hf \
