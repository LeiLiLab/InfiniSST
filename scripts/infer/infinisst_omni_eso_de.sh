...
uv run simuleval \
    ...
    --output /data/user_data/siqiouya/ckpts/infinisst-omni/gigaspeech-de-s_origin-bsz4/v1-20260122-055850-hf/evaluation/eso/en2de/seg${src_segment_size} \
    --max-new-tokens 128 \
    ...
    --top-p 0.95 \
    --top-k 20 \
    --model-name /data/user_data/siqiouya/ckpts/infinisst-omni/gigaspeech-de-s_origin-bsz4/v1-20260122-055850-hf/ \
