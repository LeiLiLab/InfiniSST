...
#SBATCH --dependency=afterok:5178319
##SBATCH --array=1-7
...
stage1_ckpt_dir="/compute/babel-5-23/siqiouya/runs/gigaspeech/en-${lang_code}/stage1_M=12_norm0_qwen_rope_robust/last.ckpt/"
save_dir=/compute/babel-5-23/siqiouya/runs/gigaspeech/en-${lang_code}/

source_lang="English"
target_lang=${lang} # e.g. German
name="stage2_M=12_norm0_qwen_rope_robust"
...
srun python train/main.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train train_xl_case_robust_asr-filtered_${lang_code}-qwen3-32b-awq_metricx-qe5.0_align \
    --data_split_eval dev_case_robust_asr-filtered_${lang_code}-qwen3-32b-awq_metricx-qe5.0_align \
