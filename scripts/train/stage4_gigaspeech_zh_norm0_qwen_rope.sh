...
##SBATCH --dependency=afterok:4944770
##SBATCH --array=1-7
...
ROOT=/compute/babel-14-5/siqiouya/lei_lecture/manifests
lang_code=zh
lang=Chinese
data_path=$ROOT

stage1_ckpt_dir="/compute/babel-5-23/siqiouya/runs/gigaspeech/en-${lang_code}/stage3_M=12_norm0_qwen_rope/last.ckpt/"
stage2_ckpt_dir="/compute/babel-5-23/siqiouya/runs/gigaspeech/en-${lang_code}/stage2_M=12_norm0_qwen_rope/last.ckpt/"
save_dir=/compute/babel-5-23/siqiouya/runs/gigaspeech/en-${lang_code}/

source_lang="English"
target_lang=${lang} # e.g. German
name="stage4_M=12_norm0_qwen_rope"
...
export WANDB_PROJECT="lei_lecture_${lang_code}"
...
srun python train/main.py \
    ...
    --lora_path ${stage2_ckpt_dir}/pytorch_model.bin \
    --lora_rank 32 \
    --use_flash_attn True \
    \
    --data_path ${data_path} \
    --data_split_train manifest_robust30_${lang_code}_simalign_train \
    --data_split_eval manifest_robust30_${lang_code}_simalign_dev \
