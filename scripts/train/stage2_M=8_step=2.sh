...
#SBATCH --dependency=afterok:4475409 
##SBATCH --array=1-7
...
stage1_ckpt_dir="/compute/babel-5-23/siqiouya/runs/en-de/release/stage1_M=8_step=2/last.ckpt/"
