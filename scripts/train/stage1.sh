...
#SBATCH --exclude=babel-3-[5,9,13,17],babel-4-[5,9,29],babel-6-29,babel-7-[1,5,9],babel-8-[5,9,13],babel-10-[5,9,13],babel-11-25,babel-12-29,babel-13-[1,13,21,29],babel-14-[21,25]
#SBATCH --partition=general
#SBATCH --time=2-00:00:00
##SBATCH --dependency=afterok:job_id
##SBATCH --array=1-7
##SBATCH --account=danielji
...
llama_path=/mnt/taurus/data/siqiouyang/download/llama-3.1-8b-instruct-hf

w2v2_path=/mnt/taurus/data/siqiouyang/download/wav2_vec_vox_960h_pl.pt
w2v2_type=w2v2
ctc_finetuned=True

ROOT=/mnt/taurus/data/siqiouyang/datasets/must-c-en-zh-daniel
lang_code=zh
lang=Chinese
data_path=$ROOT/en-${lang_code}/

save_dir=/mnt/taurus/data/danielji/must-cstage1release
...
export WANDB_PROJECT="danieljimustc_${lang_code}"
