...
#SBATCH --dependency=afterok:4345644
##SBATCH --array=1-7
...
stage1_ckpt_dir=/compute/babel-5-23/siqiouya/runs/en-zh/stage1_seamless/last.ckpt/
...
srun python train/main.py \
    \
    --seamless_path ${seamless_path} \
    --seamless_freeze True \
    \
    --block_size 48 \
    --max_cache_size 576 \
    \
