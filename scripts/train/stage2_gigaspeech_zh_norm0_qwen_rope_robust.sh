...
#SBATCH --dependency=afterok:5159034
##SBATCH --array=1-7
...
srun python train/main.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train train_xl_case_robust_ft-${lang_code}-qwen2.5-32b-instruct-awq_align_asr-filtered \
    --data_split_eval dev_case_robust_ft-${lang_code}-qwen2.5-32b-instruct-awq_align_asr-filtered \
