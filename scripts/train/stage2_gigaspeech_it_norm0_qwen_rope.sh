...
srun python train/main.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train train_xl_case_${lang_code}-qwen2.5-32b-instruct-awq_marked_mfa_asr-filtered \
    --data_split_eval dev_case_${lang_code}-qwen2.5-32b-instruct-awq_marked_mfa_asr-filtered \
