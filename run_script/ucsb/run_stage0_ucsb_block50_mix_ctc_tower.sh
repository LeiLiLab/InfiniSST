...
name=stage0-block50-mix-ctc-tower
save_path=/mnt/taurus/data/siqiouyang/runs/sllama/en-es/7b/uni/$name
...
srun python /home/siqiouyang/work/projects/sllama/train/stage0_tower.py \
