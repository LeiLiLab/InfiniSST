...
sllm_weight_path=/mnt/taurus/data/siqiouyang/runs/sllama/en-de/3.1-8B-s1-lightning-german-w2v2-rope-noxpos/
...
source_lang="English"
target_lang="German"
name="3.1-8B-s2-lightning-${target_lang,,}-${w2v2_type}-rope-noxpos"
