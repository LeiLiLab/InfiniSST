...
speech_model=/mnt/taurus/data1/siqiouyang/runs/sllama/en-fr/7b/uni/stage0-block50-mix
data_path=/mnt/taurus/data/xixu/datasets/must-c-v1.0/en-fr
name=stage3-uni-waco-block50-mix-from-stage0
save_path=/mnt/taurus/data1/siqiouyang/runs/sllama/en-fr/7b/uni/$name
