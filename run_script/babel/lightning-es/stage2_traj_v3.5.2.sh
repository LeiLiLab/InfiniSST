...
##SBATCH --dependency=afterok:4197764
##SBATCH --array=1-7
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/en-es/8B-traj-s1-v3.5.2/last.ckpt/
...
source_lang="English"
target_lang="Spanish"
name="8B-traj-s2-v3.5.2"
save_path=/compute/babel-5-23/siqiouya/runs/en-es/$name
# rm -rf ${save_path}
mkdir -p ${save_path}

export PYTHONPATH=/home/siqiouya/work/sllama
export TOKENIZERS_PARALLELISM=false
export WANDB_PROJECT="mustc_1.0_es"
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train 'train_st_es_nospeaker_traj_30mix_filtered' \
    --data_split_eval 'dev_st_es_nospeaker_traj_30mix_filtered' \
    --source_lang "${source_lang}" \
    --target_lang "${target_lang}" \
    --trajectory 4 \
    --trajectory_max_multiplier 6 \
