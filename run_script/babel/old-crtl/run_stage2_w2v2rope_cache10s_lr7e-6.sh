...
llm_path=/compute/babel-7-1/siqiouya/runs/3.1-8B-s1-english-german-w2v2-rope/checkpoint-5280/
...
source_lang="English"
target_lang="German"
name="3.1-8B-s2-${source_lang,,}-${target_lang,,}-${w2v2_type}-rope-lr7e-6-run2"
