...
llm_path=/compute/babel-5-23/siqiouya/runs/3.1-8B-s1-english-german-w2v2-rope-frz-llm-emb-origdrop/checkpoint-5118/
...
source_lang="English"
target_lang="German"
name="3.1-8B-s2-${source_lang,,}-${target_lang,,}-${w2v2_type}-rope"
...
torchrun --nproc_per_node=$SLURM_GPUS --rdzv-endpoint=0.0.0.0:9105 \
    ...
    --run_name $name \
    --bf16 True \
    --deepspeed ../configs/deepspeed_config_stage3_bf16_offload.json