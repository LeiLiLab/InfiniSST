...
#SBATCH --output=slurm_stage2_A100_80G.txt
...
llm_model=/data/user_data/siqiouya/runs/pretrained/stage1-uni-waco
ssl_model=${llm_model}/speech_tower.bin
data_path=/scratch/siqiouya/dataset/must-c-v1.0/en-es
name=stage2-uni-waco-a100-80g
...
torchrun  --nproc_per_node=$gpus --rdzv-endpoint=0.0.0.0:9106 \
    /home/siqiouya/work/sllama/train/stage2_large.py \
