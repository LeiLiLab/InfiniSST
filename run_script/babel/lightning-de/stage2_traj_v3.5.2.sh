...
##SBATCH --dependency=afterok:4197726 
##SBATCH --array=1-7
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/en-de/8B-traj-s1-v3.5.2/last.ckpt/
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train 'train_st_de_nospeaker_traj_30mix_filtered' \
    --data_split_eval 'dev_st_de_nospeaker_traj_30mix_filtered' \
