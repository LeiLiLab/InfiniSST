...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/en-de/8B-s1-bi-v3.5/last.ckpt/
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train 'train_st_de_nospeaker' \
    --data_split_eval 'dev_st_de_nospeaker' \
