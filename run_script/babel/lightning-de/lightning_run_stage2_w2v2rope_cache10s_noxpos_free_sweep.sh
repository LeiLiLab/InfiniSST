...
#SBATCH --exclude=babel-13-13,babel-13-29,babel-4-9,babel-3-5,babel-3-9,babel-6-29,babel-7-9
...
source_lang="English"
target_lang="German"
name="3.1-8B-s2-lightning-${target_lang,,}-${w2v2_type}-rope-noxpos-free-lr${lr}"
