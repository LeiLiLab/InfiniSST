...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/3.1-8B-s1-lightning-german-w2v2-rope-noxpos-cosine-bi/
...
source_lang="English"
target_lang="German"
name="3.1-8B-s2-lightning-${target_lang,,}-${w2v2_type}-rope-noxpos-cosine-bi"
