...
#SBATCH --exclude=babel-3-[5,9,13,17],babel-4-[5,9,29],babel-6-29,babel-7-[1,5,9],babel-8-[5,13],babel-10-[5,13],babel-11-25,babel-12-29,babel-13-[13,21,29],babel-14-25
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/8B-traj-s1-v2.6/last.ckpt/
