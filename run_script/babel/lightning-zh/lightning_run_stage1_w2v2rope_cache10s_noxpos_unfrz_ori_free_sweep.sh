...
lr=1e-4
training_sets=("comet_0.40" "comet_0.50" "comet_0.65" "comet_0.70")
training_set=${training_sets[$SLURM_ARRAY_TASK_ID]}
...
source_lang="English"
target_lang="Chinese"
name="8B-s1-${target_lang,,}-${w2v2_type}-${training_set}"
