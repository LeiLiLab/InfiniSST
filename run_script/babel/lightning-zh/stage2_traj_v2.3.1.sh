...
#SBATCH --exclude=babel-3-[5,9,13,17],babel-4-[5,9,29],babel-6-29,babel-7-[1,5,9],babel-8-13,babel-10-[5,13],babel-11-25,babel-12-29,babel-13-[13,29],babel-14-25
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/8B-s2-v2.0/last.ckpt/
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    --trajectory 3 \
    --trajectory_perturb 0.45 0.45 0.1 \
    \
    --seed 998244353 \
    --stage 2 \
    --train_bsz 1200 \
