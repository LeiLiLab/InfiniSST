...
#SBATCH --dependency=afterok:4127368
##SBATCH --array=1-7
...
llm_path=/compute/babel-4-1/siqiouya/llama-3-8b-instruct-hf
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/en-zh/8B-traj-s1-v3.5_llama3/last.ckpt/
