...
#SBATCH --exclude=babel-3-[5,9,17],babel-4-[1,9,29],babel-6-29,babel-7-[1,5,9],babel-8-13,babel-10-13,babel-11-25,babel-13-[13,29]
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/8B-traj-s1-v1.2/epoch\=5-step\=7128.ckpt/
