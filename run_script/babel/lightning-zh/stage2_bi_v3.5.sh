...
##SBATCH --dependency=afterok:4118475
##SBATCH --array=1-7
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/en-zh/8B-s1-bi-v3.5/last.ckpt/
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train 'train_st_zh_ft_nospeaker' \
    --data_split_eval 'dev_st_zh_nospeaker' \
