...
#SBATCH --exclude=babel-13-13,babel-13-29,babel-4-9,babel-3-5,babel-3-17,babel-3-9,babel-6-29,babel-11-25,babel-10-13,babel-7-[1,5,9]
...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/8B-traj-s1/epoch\=3-step\=4659.ckpt/
