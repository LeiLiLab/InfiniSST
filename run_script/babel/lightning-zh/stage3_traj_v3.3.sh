...
sllm_weight_path=/compute/babel-5-23/siqiouya/runs/8B-traj-s2-v3.3/last.ckpt/
...
srun python /home/siqiouya/work/sllama/train/main_lightning.py \
    ...
    \
    --data_path ${data_path} \
    --data_split_train 'train_st_zh_ft_traj_30_filtered_po10k_gpt-4o-mini-2024-07-18_fa_traj_sample' \
    --data_split_eval 'dev_st_zh_traj_30_gpt-4o-mini-2024-07-18_fa_traj_sample' \
    --source_lang "${source_lang}" \
    --target_lang "${target_lang}" \
    --trajectory 5 \
    --trajectory_max_multiplier 4 \
    --trajectory_prob_aug 0.0 \
    --preference_optimization_max_multiplier 1 \
    --cpo_beta 0.1 \
    \
    --seed 42 \
    --stage 2 \
