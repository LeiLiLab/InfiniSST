...
python forced_alignment.py --root $root --split ${split}_ft --src-lang $src_lang --tgt-lang $tgt_lang --max-duration 43.2

source /home/siqiouya/anaconda3/bin/activate base
cd /home/siqiouya/work/simalign
python build_trajectory_full.py --data-root $root --lang $tgt_lang --split ${split}_ft_fa --output-split ${split}_ft_fa_traj_45 --mult 45 --max-duration 43.2