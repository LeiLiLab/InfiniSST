            ...
            states.messages.append(
                {
                    "role": "system",
                    "content": [
                        {"type": "text", "text": f"You are a professional simultaneous interpreter. You will be given chunks of {self.source_lang} audio and you need to translate the audio into {self.target_lang} text."}
                    ]
                }
            )
        states.messages.append(
